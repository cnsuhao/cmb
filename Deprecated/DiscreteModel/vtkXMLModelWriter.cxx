                                  ...
                                  bool /*weakPtr*/)
{
  ...
  vtkSerializableObject *serializableObject =
    vtkSerializableObject::SafeDownCast(obj);
...
vtkIdType vtkXMLModelWriter::Serialize(vtkSerializableObject*& obj)
{
  ...
  std::map<vtkSerializableObject*, vtkIdType>::iterator iter =
    this->Internal->IDs.find(obj);
