...
//-----------------------------------------------------------------------------
qtCMBGeologyBuilderContextMenuBehavior::qtCMBGeologyBuilderContextMenuBehavior(pqCMBSceneTree *tree,
...
//-----------------------------------------------------------------------------
qtCMBGeologyBuilderContextMenuBehavior::~qtCMBGeologyBuilderContextMenuBehavior()
{
  this->Tree = NULL;
}

//-----------------------------------------------------------------------------
void qtCMBGeologyBuilderContextMenuBehavior::onViewAdded(pqView* view)
{
...
//-----------------------------------------------------------------------------
bool qtCMBGeologyBuilderContextMenuBehavior::eventFilter(QObject* caller, QEvent* e)
{
...
//-----------------------------------------------------------------------------
void qtCMBGeologyBuilderContextMenuBehavior::buildMenu(QPoint position)
{
