  ...
  : derived(gs)
{
  ...
  switch (n)
  {
    // n ==> 2*n-1
    case 1:
      this->intpow = rtvl_intpow_impl<double, 1>::compute;
      break;
    case 2:
      this->intpow = rtvl_intpow_impl<double, 3>::compute;
      break;
    case 3:
      this->intpow = rtvl_intpow_impl<double, 5>::compute;
      break;
    case 4:
      this->intpow = rtvl_intpow_impl<double, 7>::compute;
      break;
    case 5:
      this->intpow = rtvl_intpow_impl<double, 9>::compute;
      break;
    case 6:
      this->intpow = rtvl_intpow_impl<double, 11>::compute;
      break;
    case 7:
      this->intpow = rtvl_intpow_impl<double, 13>::compute;
      break;
    case 8:
      this->intpow = rtvl_intpow_impl<double, 15>::compute;
      break;
    default:
      vcl_abort();
  }
