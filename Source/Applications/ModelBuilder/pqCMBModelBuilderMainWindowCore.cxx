...
pqSMTKMeshPanel* pqCMBModelBuilderMainWindowCore::meshPanel()
{
  if (!this->Internal->MeshDock)
  {
    ...
    QObject::connect(this->Internal->MeshDock, SIGNAL(entitiesSelected(const smtk::common::UUIDs&)),
      this->modelPanel(), SLOT(requestEntitySelection(const smtk::common::UUIDs&)));
  }
