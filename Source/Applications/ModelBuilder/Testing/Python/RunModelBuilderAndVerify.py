...
def RunMBAndVerify():
	...
	if len(sys.argv) != 7:
		print("Incorrect Number of arguments. Got %i expected %i" % (len(sys.argv), 7))
		print("Format: %s ModelBuilderPath testdir testScript pythonExecutable verifyScript testDataRoot" % (sys.argv[0]))
