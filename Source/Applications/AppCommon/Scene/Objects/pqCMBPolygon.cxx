  ...
  : pqCMBTexturedObject()
{
  ...
  this->Source = builder->createSource("CmbArcGroup", "PolygonProvider", core->getActiveServer());
...
bool pqCMBPolygon::writeToFile()
{
  ...
  pqSMAdaptor::setElementProperty(
    writer->getProxy()->GetProperty("FileName"), this->FileName.c_str());
...
bool pqCMBPolygon::remesh()
{
  ...
  this->ValidPolygon = createOp->Create(this->MinAngle, this->EdgeLength, this->Source->getProxy());
