...
pqCMBFileDialog::pqCMBFileDialog(pqServer* server, QWidget* p, const QString& title,
...
void pqCMBFileDialog::fileSelectionChanged()
{
  ...
  for (int i = 0; i != indices.size(); ++i)
  {
    ...
    if (index.model() == &this->Implementation->FileFilter)
    {
      ...
      fullPathFiles.append(
        QFileInfo(QDir(this->Implementation->Model->getCurrentPath()), name).absoluteFilePath());
    }
  }
