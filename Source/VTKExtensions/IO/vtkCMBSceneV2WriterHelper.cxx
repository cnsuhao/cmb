/*=========================================================================
  ...
  Module:    vtkCMBSceneV2WriterHelper.cxx
...
//-----------------------------------------------------------------------------
int vtkCMBSceneV2WriterHelper::RequestData(
...
{
  std::string fullPath =
    vtksys::SystemTools::CollapseFullPath(this->FileName);
...
void vtkCMBSceneV2WriterHelper::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "Text: "
     << (this->Text ? this->Text : "(none)") << "\n";

  for (unsigned int i = 0; i < this->Internal->ObjectFileNames.size(); i++)
    {
    os << indent << "Object FileName[" << i << "]: "
       << this->Internal->ObjectFileNames[i] << endl;
    }
...
//----------------------------------------------------------------------------
int vtkCMBSceneV2WriterHelper::RequestInformation(
  vtkInformation *vtkNotUsed(request),
  vtkInformationVector **vtkNotUsed(inputVector),
  vtkInformationVector *vtkNotUsed(outputVector))
{
