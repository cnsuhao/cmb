...
#ifndef __vtkCMBMeshReader_h
#define __vtkCMBMeshReader_h
...
class VTKCMBIO_EXPORT vtkCMBMeshReader : public vtkUnstructuredGridAlgorithm
{
public:
//BTX
