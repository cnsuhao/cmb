...
#ifndef __vtkRayIntersectionLocator_h
#define __vtkRayIntersectionLocator_h
...
class VTKCMBMESHING_EXPORT vtkRayIntersectionLocator : public vtkCellTreeLocator
{
public:
