...
public:
  ...
  void SetExecuteModeToSetupRefine()
    {this->SetExecuteMode(VTK_MODE_SETUP_REFINE);};
  void SetExecuteModeToRefine()
    {this->SetExecuteMode(VTK_MODE_REFINE);};
  void SetExecuteModeToExtract()
    {this->SetExecuteMode(VTK_MODE_EXTRACT);};
  ...
  vtkSetClampMacro(RefineVisualizationOutputMode, int,
    VTK_REFINE_VIZ_OUTPUT_TO_DISK, VTK_REFINE_VIZ_OUTPUT_OFF);
  ...
  void SetOutputPtsFormatToXMLPolyData()
    {this->SetOutputPtsFormat(VTK_OUTPUT_TYPE_XML_PD);};
  void SetOutputPtsFormatToASCIIPts()
    {this->SetOutputPtsFormat(VTK_OUTPUT_TYPE_ASCII_PTS);};
  void SetOutputPtsFormatToBinaryPts()
    {this->SetOutputPtsFormat(VTK_OUTPUT_TYPE_BINARY_PTS);};
