...
public:
  ...
  void SetControlRanges(double arc_ind, double pointId,
  ...
  void SetFunctionModes(int arc_ind, int funId, int isRelative, int isSymmetric);
  void ClearFunctions( int arc_ind, int funId );
  ...
  void AddDispFunPoint( double arc_ind, double funId, double x, double y, double m, double s);
  void SelectFunctionType( int arc_ind, int funId, int weightT, int dispT);
