/*=========================================================================
  ...
  Program:   CMB
  Module:    vtkSMCMBConeCellClassifierProxy.h
...
public:
  ...
  void InsertNextCone(const double baseCenter[3], const double axisDir[3],
                      double height, double r0, double r1,
  ...
  void InsertNextCone(const double baseCenter[3], const double axisDir[3],
                      double height, double r0, double r1,
                      const double translate[3], const double orientation[3],
                      const double scaling[3], int oldVal, int newVal);
