...
vtkIdType vtkSMCMBGlyphPointSourceProxy::InsertNextPoint(double* p)
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "InsertNextPoint" << p[0] << p[1]
         << p[2] << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  vtkIdType id;
  int retVal =
    this->GetSession()->GetLastResult(vtkPVSession::DATA_SERVER_ROOT).GetArgument(0, 0, &id);
...
vtkIdType vtkSMCMBGlyphPointSourceProxy::InsertNextPoint(
  double* point, double* color, double* scale, double* orientation, int visibility)
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "InsertNextPoint" << point[0]
         << point[1] << point[2] << color[0] << color[1] << color[2] << color[3] << scale[0]
         << scale[1] << scale[2] << orientation[0] << orientation[1] << orientation[2] << visibility
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "SetVisibility" << index
         << visibility << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
//----------------------------------------------------------------------------
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "SetColor" << index << color[0]
         << color[1] << color[2] << color[3] << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
//----------------------------------------------------------------------------
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "UnsetColor" << index
         << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "ResetColorsToDefault"
         << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "SetDefaultColor" << color[0]
         << color[1] << color[2] << color[3] << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "SetGlyphSourceBounds"
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "ApplyTransform" << index
         << vtkClientServerStream::InsertArray(o, 3) << vtkClientServerStream::InsertArray(p, 3)
         << vtkClientServerStream::InsertArray(s, 3) << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
//----------------------------------------------------------------------------
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "ApplyTransform"
         << vtkClientServerStream::InsertArray(o, 3) << vtkClientServerStream::InsertArray(p, 3)
         << vtkClientServerStream::InsertArray(s, 3) << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
...
int vtkSMCMBGlyphPointSourceProxy::GetVisibility(vtkIdType index)
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "GetVisibility" << index
         << vtkClientServerStream::End;
...
vtkIdType vtkSMCMBGlyphPointSourceProxy::GetNumberOfPoints()
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "GetNumberOfPoints"
         << vtkClientServerStream::End;
...
void vtkSMCMBGlyphPointSourceProxy::GetColor(vtkIdType index, double* color)
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "GetColor" << index
         << vtkClientServerStream::End;
...
void vtkSMCMBGlyphPointSourceProxy::GetDefaultColor(double* color)
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "GetDefaultColor"
         << vtkClientServerStream::End;
...
void vtkSMCMBGlyphPointSourceProxy::GetBounds(vtkIdType index, double* b)
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << "GetBounds" << index
         << vtkClientServerStream::End;
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << func << data
         << vtkClientServerStream::End;
  this->ExecuteStream(stream);
}
//----------------------------------------------------------------------------
...
{
  vtkClientServerStream stream;
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << func << index << data[0] << data[1]
         << data[2] << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
}
//----------------------------------------------------------------------------
  ...
  const char* func, vtkIdType index, double* data)
{
  ...
  stream << vtkClientServerStream::Invoke << VTKOBJECT(this) << func << index
         << vtkClientServerStream::End;
