...
void vtkPVSceneGenObjectInformation::CopyFromObject(vtkObject* obj)
{
  ...
  vtkStringArray* objectType =
    vtkStringArray::SafeDownCast(dataObject->GetFieldData()->GetAbstractArray("ObjectType"));
  if (objectType)
  {
  ...
  vtkStringArray* objectName =
    vtkStringArray::SafeDownCast(dataObject->GetFieldData()->GetAbstractArray("ObjectName"));
  if (objectName)
  {
  ...
  vtkDoubleArray* translation =
    vtkDoubleArray::SafeDownCast(dataObject->GetFieldData()->GetArray("Translation"));
  if (translation)
  {
    translation->GetTuple(0, this->Translation);
  }

  vtkDoubleArray* orientation =
    vtkDoubleArray::SafeDownCast(dataObject->GetFieldData()->GetArray("Rotation"));
  if (orientation)
  {
  ...
  vtkDoubleArray* scale =
    vtkDoubleArray::SafeDownCast(dataObject->GetFieldData()->GetArray("Scale"));
  if (scale)
  {
  ...
  vtkStringArray* objectFileName =
    vtkStringArray::SafeDownCast(dataObject->GetFieldData()->GetAbstractArray("FileName"));
  if (objectFileName)
  {
  ...
  vtkDoubleArray* transformation =
    vtkDoubleArray::SafeDownCast(dataObject->GetFieldData()->GetArray("Transformation"));
  if (transformation)
  {
    double elements[16];
  ...
  vtkDoubleArray* color =
    vtkDoubleArray::SafeDownCast(dataObject->GetFieldData()->GetArray("Color"));
  if (color)
  {
