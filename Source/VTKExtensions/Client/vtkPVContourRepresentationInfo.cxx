...
//----------------------------------------------------------------------------
void vtkPVContourRepresentationInfo::CopyFromContourPolySource(
  vtkSceneContourSource* source )
{

  vtkPolyData *data = vtkPolyData::SafeDownCast(
  ...
  this->AllNodesWorldPositions->Resize(
...
{
  return this->AllNodesWorldPositions?
    this->AllNodesWorldPositions->GetNumberOfTuples() : 0;
}
...
int vtkPVContourRepresentationInfo::GetNumberOfSelectedNodes()
{
  return this->SelectedNodes?
    this->SelectedNodes->GetNumberOfTuples() : 0;
}

//----------------------------------------------------------------------------
void
vtkPVContourRepresentationInfo::CopyToStream(vtkClientServerStream* css)
{
  css->Reset();
...
//----------------------------------------------------------------------------
void
vtkPVContourRepresentationInfo::CopyFromStream(const vtkClientServerStream*)
{
}
//----------------------------------------------------------------------------
void vtkPVContourRepresentationInfo::GetBounds(double &xMin, double &xMax,
