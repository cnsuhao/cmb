/*=========================================================================
  ...
  Program:   CMB
  Module:    vtkSMCMBConeCellClassifierProxy.cxx
                                                     ...
                                                     int oldVal, int newVal)
{
  ...
  stream << vtkClientServerStream::Invoke
         << VTKOBJECT(this) << "InsertNextCone"
         << vtkClientServerStream::InsertArray(baseCenter, 3)
         << vtkClientServerStream::InsertArray(axisDir, 3)
         << height << r0 << r1 << oldVal << newVal
                                                     ...
                                                     int oldVal, int newVal)
{
  ...
  stream << vtkClientServerStream::Invoke
         ...
         << vtkClientServerStream::InsertArray(scaling, 3)
         << oldVal << newVal
         << vtkClientServerStream::End;
  this->ExecuteStream(stream);
  this->MarkModified(this);
