/*=========================================================================
  ...
  Module:    vtkHydroModelSelectionSource.cxx
...
//-----------------------------------------------------------------------------
int vtkHydroModelSelectionSource::RequestData(
...
{
  int fieldType = 0;
  vtkSelectionNode* selNode = (this->Selection &&
    this->Selection->GetNumberOfNodes()>0) ? this->Selection->GetNode(0) : 0;
  if(selNode)
    {
