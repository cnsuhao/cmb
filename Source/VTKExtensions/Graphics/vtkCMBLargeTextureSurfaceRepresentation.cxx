...
//----------------------------------------------------------------------------
int vtkCMBLargeTextureSurfaceRepresentation::RequestData(vtkInformation* request,
...
//----------------------------------------------------------------------------
int vtkCMBLargeTextureSurfaceRepresentation::FillInputPortInformation(int port,
  vtkInformation *info)
{
  if (port == 0)
    {
